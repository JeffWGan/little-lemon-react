...
import restaurant_food from "../../assets/restaurant-food.jpg";
  ...
  return (
    <Container>
      <Content>
        ...
        <Button onClick={() => navigate(LittleLemonPages.Reservation)} aria-label="Go to reservation table page.">Reserve a Table</Button>
      </Content>
      <Image>
